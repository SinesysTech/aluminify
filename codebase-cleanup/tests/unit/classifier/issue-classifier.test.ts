...
describe('IssueClassifier', () => {
  ...
  describe('integration', () => {
    it('should classify, prioritize, and detect patterns together', () => {
      ...
      // Check patterns
      const authPattern = classified.patterns.find(p => 
        p.category === 'authentication' && p.patternId.includes('type-safety')
      );
  ...
  describe('edge cases', () => {
    ...
    it('should handle all issue types', () => {
      const allTypes: Array<Issue['type']> = [
    ...
    it('should handle all issue categories', () => {
      const allCategories: Array<Issue['category']> = [
        'authentication',
        'database',
        'api-routes',
        'components',
