    ...
    describe('Integration with Classification', () => {
        ...
        it('should sort all patterns by priority including enhanced patterns', () => {
            ...
            for (let i = 0; i < classified.patterns.length - 1; i++) {
                expect(classified.patterns[i].priority).toBeGreaterThanOrEqual(classified.patterns[i + 1].priority);
            }
        });
    });
});
//# sourceMappingURL=pattern-detection-enhancements.test.js.map