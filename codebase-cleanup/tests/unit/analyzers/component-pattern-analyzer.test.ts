...
describe('ComponentPatternAnalyzer', () => {
  ...
  describe('Task 7.2: Prop Drilling Detection', () => {
    it('should detect prop drilling exceeding 3 levels', async () => {
      ...
      const propDrillingIssues = issues.filter(
        issue => issue.tags.includes('prop-drilling')
      );
  ...
  describe('Task 7.3: Component Pattern Inconsistency Detection', () => {
    it('should detect inconsistent prop patterns (destructuring vs object)', async () => {
      ...
      const inconsistentPatternIssues = issues.filter(
        issue => issue.type === 'inconsistent-pattern' && issue.description.includes('props')
      );
    ...
    it('should detect inconsistent export patterns', async () => {
      ...
      const exportPatternIssues = issues.filter(
        issue => issue.type === 'inconsistent-pattern' && issue.description.includes('export')
      );
    ...
    it('should detect inconsistent component definition styles', async () => {
      ...
      const definitionStyleIssues = issues.filter(
    ...
    it('should detect inconsistent event handler naming', async () => {
      ...
      const handlerNamingIssues = issues.filter(
        issue => issue.type === 'inconsistent-pattern' && issue.description.includes('Event handler')
      );
  ...
  describe('Task 7.3: Duplicate Component Logic Detection', () => {
    it('should detect duplicate validation logic', async () => {
      ...
      const duplicationIssues = issues.filter(
        issue => issue.type === 'code-duplication' && issue.description.includes('validation')
      );
    ...
    it('should detect duplicate useEffect patterns', async () => {
      ...
      const effectDuplicationIssues = issues.filter(
        issue => issue.type === 'code-duplication' && issue.description.includes('useEffect')
      );
    ...
    it('should detect duplicate data transformations', async () => {
      ...
      const transformDuplicationIssues = issues.filter(
        issue => issue.type === 'code-duplication' && issue.description.includes('transformation')
      );
    ...
    it('should detect similar component structures', async () => {
      ...
      const similarityIssues = issues.filter(
        issue => issue.type === 'code-duplication' && issue.description.includes('similar structures')
      );
