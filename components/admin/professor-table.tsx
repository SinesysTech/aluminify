...
import { ArrowUpDown, MoreHorizontal, Pencil, Trash2, Plus, GraduationCap, Search } from 'lucide-react'
    ...
    <div className="flex flex-col gap-8 h-full pb-10">
      ...
      {loading ? (
        ...
        <section id="empty-state" className="flex-1 flex flex-col items-center justify-center min-h-[400px]">
          ...
          <h3 className="text-lg font-semibold text-zinc-900 mb-2">Nenhum professor cadastrado</h3>
