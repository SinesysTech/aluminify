...
async function postHandler(request: AuthenticatedRequest) {
  ...
  try {
    ...
    console.error('[Cronograma POST] Error message:', error instanceof Error ? error.message : String(error));
    console.error('[Cronograma POST] Error stack:', error instanceof Error ? error.stack : 'N/A');
