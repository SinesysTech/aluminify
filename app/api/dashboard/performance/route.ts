...
async function getHandler(request: AuthenticatedRequest) {
  try {
    ...
    const groupBy = (searchParams.get('group_by') || 'frente') as 'curso' | 'disciplina' | 'frente' | 'modulo'
    ...
    const data = await dashboardAnalyticsService.getPerformanceFiltered(userId, {
      groupBy,
      scope,
      scopeId,
      period,
