    ...
    const popularGoogleFonts = [
      {
        ...
        description:
          "A modern, highly legible sans-serif font designed for user interfaces",
      },
      {
        family: "Roboto",
        category: "sans-serif",
        ...
        description:
          "Google's signature family of fonts with a mechanical skeleton",
      },
      {
        family: "Open Sans",
        category: "sans-serif",
      ...
      },
      {
        ...
        description:
          "Semi-rounded details of the letters give Lato a feeling of warmth",
      },
      {
        family: "Montserrat",
        category: "sans-serif",
        variants: ["300", "400", "500", "600", "700"],
        description:
          "Inspired by the old posters and signs in the traditional Montserrat neighborhood",
      },
      {
        family: "Poppins",
        category: "sans-serif",
      ...
      },
      {
        ...
        description:
          "Transitional design with high contrast and distinctive details",
      },
      {
        family: "Merriweather",
        category: "serif",
        variants: ["300", "400", "700"],
        description:
          "Designed to be a text face that is pleasant to read on screens",
      },
      {
        family: "Fira Code",
        category: "monospace",
      ...
      },
      {
        ...
        variants: ["300", "400", "500", "600", "700"],
        description:
          "Typeface for developers with increased height for better readability",
      },
      {
