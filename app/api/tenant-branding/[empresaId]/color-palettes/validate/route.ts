...
async function postHandler(
  ...
  try {
    ...
    const requiredColors = ['primaryColor', 'backgroundColor', 'secondaryColor', 'accentColor'];
    ...
    const accessibilityReport = await colorPaletteManager.validateColorContrast(body);
