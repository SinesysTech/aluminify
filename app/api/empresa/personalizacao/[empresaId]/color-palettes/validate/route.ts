...
import { ColorPaletteManagerImpl } from "@/app/[tenant]/(modules)/settings/personalizacao/services";
import {
...
import type { CreateColorPaletteRequest } from "@/app/[tenant]/(modules)/settings/personalizacao/services/brand-customization.types";
