...
const TEMPLATE_COLUMNS: StudentTemplateColumn[] = [
  ...
  },
  {
    ...
    required: false,
    example: '12345678900',
    description: 'Opcional. Se não preencher, a senha padrão será o CPF (11 dígitos).',
  },
];
...
export class StudentTemplateService {
  async generateTemplate(): Promise<Buffer> {
    ...
    const notes = [
      ...
      '4. O CPF deve conter apenas números (11 dígitos). Se vier com 10 dígitos, será adicionado 0 à esquerda.',
      ...
      '8. Se a senha temporária não for preenchida, será usada como padrão o CPF (11 dígitos)',
