...
- Path alias configured in `tsconfig.json`:
  ```json
  "@/brand-customization/*": ["./app/[tenant]/(modules)/brand-customization/*"]
  ```

### Integration Points
- **Settings Integration**: `app/[tenant]/(modules)/configuracoes/components/perfil/branding-settings.tsx`
...
- `app/[tenant]/(modules)/admin/empresa/branding/` → `/` (root)
