...
import { BulkActionsBar } from '@/app/[tenant]/(dashboard)/usuario/components/bulk-actions-bar'
import { TransferStudentsDialog } from '@/app/[tenant]/(dashboard)/usuario/components/transfer-students-dialog'
import type { CourseOption, Aluno } from '@/app/[tenant]/(dashboard)/usuario/components/aluno-table'
