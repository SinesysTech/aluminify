-- Fix: Ensure importar_cronograma_aulas resolves disciplina within tenant (empresa)
-- Problem: disciplina lookup was name-only, which can pick a discipline from another empresa
-- (e.g. "Filosofia"), causing frentes/modulos/aulas to be linked to the wrong disciplina_id.
--
-- Date: 2026-01-27
