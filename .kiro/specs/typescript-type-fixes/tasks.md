...
- [x] 1. Fix duplicate Json type definition
...
- [x] 2. Regenerate database types from Supabase schema
...
- [x] 3. Update Supabase client creation with Database type parameter
  - [x] 3.1 Update `backend/clients/database.ts`
  ...
  - [x] 3.2 Update `lib/server.ts` (if exists)
    - Import `Database` type
    - Add `<Database>` type parameter to `createClient()`
    - Update return type to `SupabaseClient<Database>`
    - _Requirements: 3.1, 3.5_
  
  - [x] 3.3 Update `lib/client.ts` (if exists)
    - Import `Database` type
    - Add `<Database>` type parameter to `createClient()`
    - Update return type to `SupabaseClient<Database>`
    - _Requirements: 3.1, 3.5_

- [x] 4. Checkpoint - Verify client type propagation
  - Ensure all tests pass, ask the user if questions arise.

- [x] 5. Fix repository layer types
  - [x] 5.1 Update `backend/services/teacher/teacher.repository.ts`
  ...
  - [x] 5.2 Update other repository files in `backend/services/`
...
- [x] 5.3 Write property test for query result type inference
  - **Property 4: Query Result Type Inference**
  - **Validates: Requirements 3.1, 3.2, 3.3, 3.4, 3.5**

- [x] 6. Fix insert and update operations
  - [x] 6.1 Update insert operations in repositories
    - Use Insert types for insert data
    - Verify required fields are enforced
    - Verify optional fields can be omitted
    - _Requirements: 4.1, 4.3, 4.4, 4.5_
  
  - [x] 6.2 Update update operations in repositories
    - Use Update types for update data
    - Verify all fields are optional
    - Verify type safety is maintained
    - _Requirements: 4.2, 4.5_

- [x] 6.3 Write property tests for insert/update type safety
  - **Property 5: Insert Operation Type Safety**
  - **Validates: Requirements 4.1, 4.3, 4.4, 4.5**
  - **Property 6: Update Operation Type Safety**
  - **Validates: Requirements 4.2, 4.5**

- [x] 7. Add type assertions for complex queries
  - [x] 7.1 Identify queries with joins in `lib/auth.ts`
  ...
  - [x] 7.2 Identify queries with joins in `backend/services/`
...
- [x] 8. Checkpoint - Verify backend type safety
  - Ensure all tests pass, ask the user if questions arise.
